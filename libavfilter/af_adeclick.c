...
typedef struct AudioDeclickContext {
    ...
    int (*detector)(struct AudioDeclickContext *s, double sigmae, double *detection,
...
static int detect_clips(AudioDeclickContext *s, double unused0,
...
static int detect_clicks(AudioDeclickContext *s, double sigmae,
