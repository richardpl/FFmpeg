...
static void upmix_2_0(AVFilterContext *ctx,
                      float l_phase,
                      float r_phase,
                      float c_phase,
                      float mag_total,
...
static int init(AVFilterContext *ctx)
{
    ...
    case AV_CH_LAYOUT_7POINT1:
        ...
        break;
    default:
        av_log(ctx, AV_LOG_ERROR, "Unsupported channel layout '%s'.\n",
               s->out_channel_layout_str);
        return AVERROR(EINVAL);
    }
...
static const AVOption surround_options[] = {
    { "channel_layout", "set output channel layout", OFFSET(out_channel_layout_str), AV_OPT_TYPE_STRING, {.str="5.1"}, 0,  0, FLAGS },
