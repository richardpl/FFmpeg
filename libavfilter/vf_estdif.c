...
#define MIDL(type, ss)                                         \
static unsigned midl_##ss(const type *prev, const type *next,  \
                          int end, int x, int k)               \
{                                                              \
...
#define DIFF(type, ss)                                         \
static unsigned diff_##ss(const type *prev, const type *next,  \
...
#define COST(type, ss)                                         \
static unsigned cost_##ss(const type *prev, const type *next,  \
                          int end, int x, int k)               \
{                                                              \
